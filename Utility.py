...
def perspective(file):
    ...
    file.write("			<lookat target=\"0, 0, 0\" origin=\"0, 0, 65\" up=\"0, -1, 0\"/>\n")
...
def envmap(file):
    ...
    file.write("		<string name=\"filename\" value=\"ocean.png\"/>\n")
    file.write("		<transform name=\"toWorld\">\n")
    file.write("			<rotate x=\"1\" angle=\"30\"/>\n")
    file.write("			<rotate y=\"1\" angle=\"180\"/>\n")
    file.write("			<rotate z=\"1\" angle=\"0\"/>\n")
    file.write("		</transform>\n")
    file.write("	</emitter>\n")

def glass(file):
    file.write("	<shape type=\"obj\" id=\"Glass_Final\">\n")
    file.write("		<string name=\"filename\" value=\"Window_pane_1.obj\"/>\n")
    file.write("		<transform name=\"toWorld\">\n")
    file.write("			<scale x=\"2\" y=\"3\" z=\"-1\"/>\n")
    file.write("		</transform>\n")
